...
| 5   | Sync            | done    | 1 new main spec (brand-system) + 3 modified (video-spec, video-validation, video-rendering, including 2 requirement renames); `openspec validate --specs` passes 5/5.                                              |
| 6   | Archive         | done    | Moved to openspec/changes/archive/2026-08-13-brand-system/. `openspec validate --specs` still passes 5/5.                                                                                                          |
...
- 2026-08-13 — Archived the change to openspec/changes/archive/2026-08-13-brand-system/. Phase 2 (Design System) shipped end to end.
